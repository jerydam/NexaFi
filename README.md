...
The metrics section shows live updates to NexaFi  including the following: ULT Total Supply, ULT Price, Protocol Blockchain, Total number of Loans, Max Loan Amount, Min Loan Amount, contract addresses of all contracts used by the protocol and Live BTC market chart.
...
### NexaFi  Token (ULT)
The NexaFi  token (ULT) is the native token of NexaFi  and is used as a collateral for lending. Other tokens available as collaterals currently are USDT and DAI. 
...
### NexaFi  ERC20 (ULT) Contract

✅ [NexaFi  Token](https://explorer.testnet.rootstock.io/address/0x1d5cd5833f43c63f724ebb0f28c6aaed79bf5bf2) 🟢
