...
export default function Dashboard(){
  ...
  return (
    <>
    <Head>
   <title>NexaFi  Dashboard - Gateway to NexaFi 's Ecosystem</title>
    ...
    <div className='dashboardmenulg h-[100%] bg-[#111] text-[#fff]' style={{zIndex:"999", position:"fixed", boxShadow:"2px 2px 2px 2px #502", overflow:"auto"}}> 
     <div className='px-[0.5cm] py-[0.6cm] text-center' style={{display:"block"}}>
      ...
      <div className='mt-[15%] p-[0.5cm]' style={{display:"block"}}>
       <div><Link href="https://github.com/mrpatrick030/NexaFi /blob/main/README.md"><button className='m-[0.2cm] rounded-md bg-[#502] px-[0.3cm] py-[0.15cm] text-[#fff]'>Docs <img src="images/documentation.png" width="17" className='ml-[0.2cm]' style={{display:"inline-block"}}/></button></Link></div>
   ...
   <div className='w-[70%] h-[100%] bg-[#111] text-[#fff]' data-aos="fade-right" style={{boxShadow:"2px 2px 2px 2px #502", overflow:"auto"}}> 
     <div className='px-[0.5cm] py-[0.6cm] text-center' style={{display:"block"}}>
      ...
      <div className='mt-[15%] p-[0.5cm]' style={{display:"block"}}>
       <div><Link href="https://github.com/mrpatrick030/NexaFi /blob/main/README.md"><button onClick={(e) => setMountSmallMenu(false)} className='m-[0.2cm] rounded-md bg-[#502] px-[0.3cm] py-[0.15cm] text-[#fff]'>Docs <img src="images/documentation.png" width="17" className='ml-[0.2cm]' style={{display:"inline-block"}}/></button></Link></div>
