...
export default function MetricsSection() {
    ...
    return (
        <div>
        <div className="font-[500] bg-[#502] px-[0.4cm] py-[0.15cm] rounded-md mb-[0.2cm]" style={{display:"inline-block", boxShadow:"2px 2px 2px 2px #333"}}>NexaFi  Metrics</div>
        <div className="text-[#ccc] text-[90%]">View current status of NexaFi </div>
